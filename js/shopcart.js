...
inpcode = 'Wacky Buttons, Inc.<br />101 Lincoln Parkway Suite E<br />East Rochester, NY 14445<br /> <br />';
...
inpcode = 'You can enter your apartment number, suite number, floor number, etc... on this line.</li><li>You can also use this line if your address is just really long and you just need more room to write your address.</li><li>If you have more than 2 lines in your address, you can combine 2 lines onto one line by separateing them with a comma(,).</li><li>If you have any questions about inputting your shipping address please feel free to ask. We would be glad to help you out (Our phone number is 585-267-7670).';
$('#dialog_content').html(inpcode);
}
